    ...
    <div class="jumbotron">
        <div class="container">
            ...
            <table class="table table-dark">
                ...
                <tbody>
                <%
                    List<Medecin> medecins = (List) request.getAttribute("meds");
                ...
                <tr>
                    ...
                    <td><%=c.getNom()%></td>
                    <td><%=c.getPrenom()%></td>
                    <td><%=c.getSpecialite()%></td>
                    <td><a href="./deletemedecin?id=<%=c.getId()%>" class="btn btn-danger"> Delete</a></td>
                    <td><a href="./updatemedecin?id=<%=c.getId()%>" class="btn btn-success"> Update</a></td>
                </tr>
